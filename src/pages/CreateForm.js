    ...
    <div>
      ...
      <div className="menu-wrapper">
        <div className="hor-menu-wrapper">
          <div className="hor-menu">
            <div className="hor-menu-ele-act" style={{ width: "100%" }}>
              내용추가
            </div>
          </div>
        </div>
      ...
      <div className="content-wrapper">
        <div className="content-box">
          <pre className="explain">초기화면</pre>
        </div>
      </div>
          ...
          <div className="hor-menu">
            <Grid container spacing={2}>
              <Grid item xs={6} onClick={(event) => handleTab(0)}>
                <div
                  className={
                    tabIndex === 0 ? "hor-menu-ele-act" : "hor-menu-ele"
                  }
                >
                  문항설정
                </div>
              ...
              <Grid item xs={6} onClick={(event) => handleTab(1)}>
                <div
                  className={
                    tabIndex === 1 ? "hor-menu-ele-act" : "hor-menu-ele"
                  }
                >
                  설문설정
                </div>
        ...
        {tabIndex === 0 ? (
          <div>
            ...
            <SelectField
              items={types}
              setItem={updateType}
              selected={data[selectedIndex].type}
            ...
            <div>
              ...
              <SetButtonField
                buttonText={data[selectedIndex].buttonText}
                setButtonText={updateButtonText}
              />
            </div>
            {selectedIndex !== 2 ? (
              <div>
                <CheckFollowingOption
                  name="시간설정"
                  checked={data[selectedIndex].timeChecked}
                  checkedChange={updateTimeChecked}
                  option={
                    <SelectField
                      items={timeOptions}
                      setItem={updateTime}
              ...
              <ExitField
                data={data[2]}
                exitCheckedChange={updateExitChecked}
                exitLinkChange={updateExitLink}
                exitCustominkChange={updateExitCustomLink}
              />
            )}
          </div>
        ) : (
          ...
          setting: {
            ...
            <CheckFollowingOption
              name="시작/종료일 설정"
              checked={setting.setTime}
              checkedChange={updateSetTime}
            />
          </div>
        )}
      </div>
